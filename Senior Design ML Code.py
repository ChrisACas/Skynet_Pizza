...
data= pd.DataFrame()
data = pd.read_csv(r'C:\Users\Kaiser\Desktop\recipe_output1.csv',encoding ='utf-8')
...
indv_lines = data['Ingredients connected'].values.tolist()
...
Skynet Pizzeria Recommendation System:
